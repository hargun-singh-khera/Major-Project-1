        ...
        <div className="col-md-6 px-4">
          <div className="card-body">
            ...
            <div className="d-flex align-items-center gap-4">
              <h3 className="fs-2 fw-bold">₹{Math.round(price * ((100-discount)/100))}</h3>
              <h4 className="text-body-tertiary fw-light text-decoration-line-through text-opacity-50">₹{price}</h4>
            </div>
            <h4 className="text-body-tertiary fw-light mb-4">{discount}% Off</h4>
            ...
            <div className="d-flex">
              ...
              <div className="d-flex flex-wrap gap-4 ms-2">
                {size.map((item, index) => (
                  <button key={index} className="btn btn-outline-secondary rounded-0">{item}</button>
                ))}
              </div>
            </div>
            <hr />
