            ...
            <div className="row g-0">
              ...
              <div className="col-md-8">
                <div className="card-body">
                  ...
                  <Link onClick={() => setSeason("Summer")} to={"/shop/products"} className="btn btn-outline-success px-5 py-2" href="#shopByCategory">Shop Now</Link>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="row g-0">
              ...
              <div className="col-md-8">
                <div className="card-body">
                  ...
                  <Link onClick={() => setSeason("Winter")} to={"/shop/products"} className="btn btn-outline-success px-5 py-2" href="#shopByCategory">Shop Now</Link>
                </div>
              </div>
            </div>
          </div>
